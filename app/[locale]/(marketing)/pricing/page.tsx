...
const PLAN_KEYS = ['free', 'professional', 'business'] as const
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link href="/audit" className="text-purple-600 hover:text-purple-700 transition font-medium">{t('pricingPage.freeAudit')}</Link>
      ...
      <main className="container mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {PLAN_KEYS.map((planKey) => {
            ...
            const notIncluded = t.raw(`pricingPage.plans.${planKey}.notIncluded`) as string[]
              ...
              >
                ...
                <div className="text-center mb-6">
                  <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4 ${
                    ...
                    <Icon className={`h-7 w-7 ${config.popular ? 'text-white' : 'text-gray-600'}`} />
                  </div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-1">{t(`pricingPage.plans.${planKey}.name`)}</h3>
                  <p className="text-gray-500">{t(`pricingPage.plans.${planKey}.description`)}</p>
                </div>
                ...
                <Button
                  ...
                  size="lg"
                >
                  {loading === config.key ? 'Loading...' : t(`pricingPage.plans.${planKey}.cta`)}
                </Button>
              </div>
            )
          })}
        ...
        <div className="mt-16 text-center">
          <div className="max-w-2xl mx-auto bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl border border-purple-100 p-8 shadow-lg">
            ...
            <Button variant="outline" className="border-gray-300" asChild>
              <a href="mailto:enterprise@getcitedby.com">{t('pricingPage.enterprise.cta')}</a>
            </Button>
          </div>
        </div>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {t('pricingPage.faq.q1.question')}
              </h3>
              <p className="text-gray-600">
                {t('pricingPage.faq.q1.answer')}
              </p>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {t('pricingPage.faq.q2.question')}
              </h3>
              <p className="text-gray-600">
                {t('pricingPage.faq.q2.answer')}
              </p>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {t('pricingPage.faq.q3.question')}
              </h3>
              <p className="text-gray-600">
                {t('pricingPage.faq.q3.answer')}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-8 text-gray-600">
              ...
              <a href="mailto:support@getcitedby.com" className="hover:text-gray-900 transition">{t('footer.contact')}</a>
            </div>
